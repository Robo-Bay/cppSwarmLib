...
#include <cppSwarmLib/UnitComponent/ITaskManagerC.hpp>
#include <cstdarg>
#include <type_traits>
namespace swarm {
/**
 ...
 * IExecutorUnitC.
 */
template <class DD, class UnitParamsT = EmptyParams,
...
public:
  BasicSwarmUnit()
      : _taskManagerC(*new _TaskManagerT((UnitT *)this)),
        _communicationC(*new _CommunicationT((UnitT *)this)),
        _executorC(*new _ExecutorT((UnitT *)this)) {}
  BasicSwarmUnit(const UnitParamsT &p)
      : _params(p), _taskManagerC(*new _TaskManagerT((UnitT *)this)),
        _communicationC(*new _CommunicationT((UnitT *)this)),
        _executorC(*new _ExecutorT((UnitT *)this)) {}
  void init() {
    _taskManagerC.init();
...
class EmptySwarmUnit
    : public BasicSwarmUnit<EmptySwarmUnit, EmptyParams, EmptyTaskManagerC,
                            EmptyCommunicationC, EmptyExecutorC> {
public:
  EmptySwarmUnit()
      : BasicSwarmUnit<EmptySwarmUnit, EmptyParams, EmptyTaskManagerC,
                       EmptyCommunicationC, EmptyExecutorC>() {}
